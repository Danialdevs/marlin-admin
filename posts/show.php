...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-2xl">
        <div class="mb-5">
            <a href="./list.php" class="font-medium text-sm inline-flex items-center text-blue-500 hover:text-blue-800">
        ...
        <div class="flex flex-wrap gap-2 mt-1">
            <a  href="category_select.php?id=<?= $post["id"] ?>" class="inline-flex items-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 font-medium rounded-lg text-sm px-5 py-2.5 mr-0 text-center me-2">
                <svg class="mr-1 -ml-1 w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <a href="image_upload.php?id=<?= $post["id"] ?>" class="inline-flex items-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 font-medium rounded-lg text-sm px-5 py-2.5 mr-0 text-center me-2">
                <svg class="mr-1 -ml-1 w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <a  href="status-toggle.php?id=<?= $post["id"] ?>" class="inline-flex items-center text-white bg-black hover:bg-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-0 text-center me-2">
                <svg class="mr-1 -ml-1 w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.933 13.909A4.357 4.357 0 0 1 3 12c0-1 4-6 9-6m7.6 3.8A5.068 5.068 0 0 1 21 12c0 1-3 6-9 6-.314 0-.62-.014-.918-.04M5 19 19 5m-4 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
                </svg>

                <?= $post['status'] == "active" ? "Скрыть" : "Показать" ?>
            </a>

            <a href="edit.php?id=<?= $post["id"] ?>" class="inline-flex items-center text-white ml-0 bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-yellow-900">
        ...
        <dl class="flex items-center space-x-6 mt-5">
            ...
            <div>
                ...
                <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400"><?= $post['views'] ?></dd>
            </div>
        </dl>
        <h2 class="mb-2 mt-5 text-xl font-semibold leading-none text-gray-900 md:text-2xl dark:text-white"><?= $post['title'] ?></h2>
